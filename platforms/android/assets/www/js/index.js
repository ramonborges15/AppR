...
function fncIA_MLP_ExecutaAlgoritmoDeTesteNox(obj){
  ...
  if(saidaRNA == 0){
      alert("Classe 0 - Nenhuma poluição de nox");
  }
	if(saidaRNA == 1){
      alert("Classe 1 - Pouca poluição de nox!");
  }
  if(saidaRNA == 2){
      alert("Classe 2 - Média poluição de nox");
  }
  if(saidaRNA == 3){
      alert("Classe 3 - Muita poluição de nox");
  }
	/*
	if (den_geral > 0.0) {
...
function fncIA_MLP_ExecutaAlgoritmoDeTesteAmonia(obj){
  ...
  if(saidaRNA == 0){
      alert("Classe 0 - Nenhuma poluição de amonia");
  }
	if(saidaRNA == 1){
      alert("Classe 1 - Pouca poluição de amonia!");
  }
  if(saidaRNA == 2){
      alert("Classe 2 - Média poluição de amonia");
  }
  if(saidaRNA == 3){
      alert("Classe 3 - Muita poluição de amonia");
  }
	/*
	if (den_geral > 0.0) {
		// Define o erro medio das classes.
...
function fncIA_MLP_ExecutaAlgoritmoDeTesteOxidoNitroso(obj){
  ...
  if(saidaRNA == 0){
      alert("Classe 0 - Nenhuma poluição de OxidoNitroso");
  }
	if(saidaRNA == 1){
      alert("Classe 1 - Pouca poluição de OxidoNitroso!");
  }
  if(saidaRNA == 2){
      alert("Classe 2 - Média poluição de OxidoNitroso");
  }
  if(saidaRNA == 3){
      alert("Classe 3 - Muita poluição de OxidoNitroso");
  }
	/*
	if (den_geral > 0.0) {
		// Define o erro medio das classes.
