// Chart code
    ...
    function recebeDados(temprValue, oxignValue, amonValue, waterValue, enxofValue, nitricValue, velocityValue) {
        ...
        chart = AmCharts.makeChart( "chartdiv4", {
          ...
          "dataProvider": [ {
            "category": "Água (%)",
            "bad": 20, "poor": 20,"average": 20, "good": 20, "excelent": 20,

            "limit": waterValue, "full": 100,

            "bullet": document.getElementById("agua").value //barra
          } ],

          "valueAxes": [ {
            "maximum": 100, "stackType": "regular", "gridAlpha": 0
          } ],
        ...
        chart = AmCharts.makeChart( "chartdiv5", {
          ...
          "dataProvider": [ {
            "category": "D. Enxof (ppm)",
            "bad": 20, "poor": 20,"average": 20, "good": 20, "excelent": 20,

            "limit": enxofValue, "full": 100,
...
/*******************************************************************************************************/
    ...
    function fncIA_RBCKMeans_ExecutaAlgoritmoDeTesteSaida_3(setTeste){
        ...
        //alert("- Cluster: "+ idc + " - Instancia + parecida: "+ idd);
        alert("RBC+KMEANS " + var_TadKM2.data[idd].coord);
    }
